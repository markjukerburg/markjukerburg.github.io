...
Recipe(title: "Avocado Crostini",
       ...
       preparation: 20,
       cooking: 0,
       instructions: [ "In a small jar, add the olive oil, lemon juice, salt, pepper and the stalks of the parsely. Closed the lid and shake until combined into an almost creamy texture.",
       ...
       ingredients: [ "1 punnet cherry Tomatoes, halved",
